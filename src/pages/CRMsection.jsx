...
import { AlertSystem } from "../components/charts/AlertSystem";
...
const CRMsetion = () => {
    ...
    const mockEmployeeData = [
      {
        ...
        name: "Mo Salah",
        efficiency: 0.8,
        dailyEfficiency: [0.7, 0.9, 0.9, 0.85, 0.75],
      },
      {
        id: 2,
        name: "Sadio Mane",
        efficiency: 0.75,
        dailyEfficiency: [0.7, 0.8, 0.7, 0.9, 0.85],
      },
      {
        id: 3,
        name: "Virgil Van Dijk",
        efficiency: 0.9,
        dailyEfficiency: [0.8, 0.85, 0.95, 0.9, 0.8],
      },
      {
        id: 4,
        name: "Alisson Becker",
        efficiency: 0.85,
        dailyEfficiency: [0.75, 0.8, 0.9, 0.85, 0.8],
      },
      {
        id: 5,
        name: "Alexander-Arnold",
        efficiency: 0.8,
        dailyEfficiency: [0.6, 0.75, 0.85, 0.4, 0.45],
      },
      {
        id: 6,
        name: "Andrew Robertson",
        efficiency: 0.78,
        dailyEfficiency: [0.68, 0.52, 0.75, 0.8, 0.58],
      },
    ];
  ...
  const checkForAlerts = () => {
    ...
    if (financialData) {
      ...
      if (
        financialData.revenue[lastMonthIndex] <
        financialData.expenses[lastMonthIndex]
      ) {
        newAlerts.push({
          id: Date.now(),
    ...
    employeeData.forEach((employee) => {
      const averageEfficiency =
        employee.dailyEfficiency.reduce((a, b) => a + b, 0) /
        employee.dailyEfficiency.length;
