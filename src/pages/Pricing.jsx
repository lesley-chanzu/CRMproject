...
const pricingPlans = [
  {
    ...
    Price: "$0",
    description:
      "Basic features for individuals and small teams to get started.",
    features: [
    ...
    <div className="container mx-auto p-6 mt-12">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mt-2">
          Upgrade your workflow with GoodDay&apos;s flexible pricing plans.
          Whether you are a solo user or part of a large team, we have the right
          plan for you.
        </p>
      </div>
        ...
        {pricingPlans.map((plan) => (
          <motion.div
            ...
            className={`bg-white rounded-xl shadow-md border border-gray-200 transition-all duration-300 ${
              plan.mostPopular ? "border-purple-500" : ""
            }`}
          >
            <div className="p-6">
              <h2
                className={`text-2xl font-semibold mb-3 ${
                  plan.mostPopular ? "text-purple-600" : " text-gray-500"
                }`}
              >
                {plan.title}
                {plan.mostPopular && (
                  <span className="ml-2 px-2 rounded-full bg-purple-200 text-puprle-600 text-xs font-medium inline-block">
                    Most Popular
                  </span>
                )}
              </h2>
        ...
        <div className="space-y-4">
          <Accordion title="What payment methods do you accept?">
            <p>
              ...
              enterprise plans, we can also accommodate other payment methods.
            </p>
          ...
          <Accordion title="Is there a discount for annual billing/subscriptions?">
            <p>
              Yes, we offer a discount for annual subscriptions. You can save up
              to 20% by choosing the annual billing option.
            </p>
            <div className="flex items-center gap-2 mt-2">
          ...
          <Accordion title="How does the free trial work?">
            <p>
              Our free trial allows you to explore all premium features for 14
              days. No credit card is required, and you can cancel anytime.
            </p>
            <div className="flex items-center gap-2 mt-2">
